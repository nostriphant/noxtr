...
namespace OCA\Noxtr\SettingSections;
...
class AdminSection implements IIconSection {
    ...
    public function getID() {
        return 'noxtr_admin'; //or a generic id if feasible
    }
    ...
    public function getIcon() {
        return $this->urlGenerator->imagePath('noxtr', 'app-dark.svg');
    }
}
